        ...
        <fieldset>
            ...
            <form action="" id="filter-report">
                ...
                <div class="row align-items-end">
                    ...
                    <div class="form-group col-md-3">
                        <small class="text-muted mx-2">Status</small>
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<tbody>
					<?php 
						...
						$qry = $conn->query("SELECT r.*,rr.name as room_name, rr.type as room_type from `reservation_list` r inner join `room_list` rr on r.room_id = rr.id where ( (date(`check_in`) Between '{$from}' and '{$to}') or (date(`check_out`) Between '{$from}' and '{$to}') ) {$where} order by r.`status` asc, unix_timestamp(r.`date_created`) desc ");
